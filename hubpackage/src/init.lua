--[[
  ...
  LAN Presence Driver for LAN-based devices/apps that can send an HTTP message when present or not present
...
local function create_device(driver)
  ...
  local MODEL = 'LAN Presence Device'
  local VEND_LABEL = 'LAN Presence Device'
  local ID = 'LANPresence_' .. socket.gettime()
  local PROFILE = 'lanpresence.v1'
...
log.info ('LAN Presence Sensor Driver v1.3 Started')
